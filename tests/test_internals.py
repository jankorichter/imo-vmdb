"""Unit tests for internal implementation details (not part of the public API)."""
...
from imo_vmdb.model.sky import Ephemeris, Location, Sky
...
class TestCheckPeriod:
    ...
    def _make_parser(self, try_repair=True, is_permissive=False):
        return CsvParser(
            MagicMock(),
            logging.getLogger("test_check_period"),
