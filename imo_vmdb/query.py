...
@dataclass
class Rate:
    """Single normalised rate observation returned by :func:`query_rates`.
...
@dataclass
class Magnitude:
    """Single normalised magnitude observation returned by :func:`query_magnitudes`.
...
@dataclass
class Rates:
    """Return value of :func:`query_rates`.
...
@dataclass
class Magnitudes:
    """Return value of :func:`query_magnitudes`.
...
def query_rates(db_conn: DBAdapter, f: RateFilter) -> Rates:
    ...
    :return: A :class:`Rates` instance.  ``sessions`` and ``magnitudes`` are
        only set when the corresponding flags on *f* are ``True``.
    """
...
def query_magnitudes(db_conn: DBAdapter, f: MagnitudeFilter) -> Magnitudes:
    ...
    :return: A :class:`Magnitudes` instance.  ``sessions`` and ``magnitudes``
        are only set when the corresponding flags on *f* are ``True``.
    """
